...
class DoublyLinkedList<T extends Comparable<T>> {
     ...
     *             is 0 (zero). If position is less than 0 then add to the head of the list.
     *             If position is greater or equal to the size of the list then add the
     ...
     * @return the data at position, if position is within the bounds of the list, and null otherwise.
     * <p>
     * Worst-case asymptotic running time cost: O(n)
     * <p>
     * Justification:
    ...
    /**
     * Deletes the element of the list at position .
     * First element in the list has position 0. If points outside the
